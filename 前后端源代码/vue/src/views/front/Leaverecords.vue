<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm class="ml-5" confirm-button-text='确认' cancel-button-text='取消' icon="el-icon-info" icon-color="red"
        title="确定批量删除这些信息吗？" @confirm="delBatch">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="success" @click="handleEdit(scope.row)" :disabled="scope.row.state !== '待审核'"><i
              class="el-icon-edit-outline" />编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form label-width="120px" size="small" :rules="rules" :model="form" ref="LeaverForm">
        ...
        <el-form-item label="请假起始日期" prop="startDate">
          <el-date-picker v-model="form.startDate" type="datetime" format="yyyy-MM-dd HH" value-format="yyyy-MM-dd HH"
            placeholder="选择日期时间"></el-date-picker>
        </el-form-item>
        <el-form-item label="请假结束日期" prop="endDate">
          <el-date-picker v-model="form.endDate" type="datetime" format="yyyy-MM-dd HH" value-format="yyyy-MM-dd HH"
            placeholder="选择日期时间"></el-date-picker>
        </el-form-item>
