...
-- Records of attend
-- ----------------------------
INSERT INTO `attend` VALUES (14, 5, '吕成龙', '2023-07-21', '09:30', '17:30', '迟到，早退');
INSERT INTO `attend` VALUES (15, 5, '派大星', '2023-07-20', '08:30', '16:30', '早退');
INSERT INTO `attend` VALUES (16, 7, '章鱼哥', '2023-07-20', '08:45', '15:00', '早退');
INSERT INTO `attend` VALUES (17, 7, '蟹老板', '2023-07-21', '08:30', '16:15', '早退');
INSERT INTO `attend` VALUES (19, 14, '痞老板', '2023-07-28', '09:00', '18:00', '正常出勤');
INSERT INTO `attend` VALUES (20, 7, '珊迪', '2023-08-09', '08:30', '14:45', '早退');
INSERT INTO `attend` VALUES (21, 16, '海绵宝宝', '2023-08-17', '10:00', '16:00', '迟到，早退');
...
-- ----------------------------
INSERT INTO `department` VALUES (1, '技术部', '1', 1001, '开发');
INSERT INTO `department` VALUES (2, '后勤部', '2', 1002, '安保');
INSERT INTO `department` VALUES (3, '管理部', '3', 1003, '老板');
INSERT INTO `department` VALUES (4, '外联部', '4', 1004, '社交');
INSERT INTO `department` VALUES (9, '招聘部', '5', 1005, 'HR');
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (5, '海绵宝宝', 2, '后勤', '保安', '2024-07-12', NULL, '2554364378@qq.com', '13255446655', '湖北武汉', '2023-07-13 11:04:19', '2024-08-07 14:57:12');
INSERT INTO `employee` VALUES (7, '吕成龙', 1, '技术部', NULL, '2024-08-18', NULL, '2593224458@qq.com', '13466554477', '湖北武汉', '2023-07-13 11:11:35', '2024-08-07 14:56:30');
INSERT INTO `employee` VALUES (14, '派大星', 4, '合欢部', '合欢快乐啊', '2024-08-07', NULL, '222@163.com', '13755447766', '北京', '2023-08-07 14:56:09', '2024-08-07 14:57:57');
INSERT INTO `employee` VALUES (16, '章鱼哥', 9, '保安部', '保安', '2024-08-07', NULL, '233@qq.com', '14577668888', '广东深圳', '2023-08-07 19:49:06', '2024-08-07 19:49:34');
...
-- ----------------------------
INSERT INTO `leaverecords` VALUES (45, '吕成龙', '本帅哥要请假', '2023-08-07 10:44:04', '2023-08-07 10', '2023-08-09 10', 'http://localhost:9090/file/b3335cd3fae54706b75abd947c309235.jpg', '审核不通过...就不让你过嘿嘿');
INSERT INTO `leaverecords` VALUES (46, '海绵宝宝', '我就要请假，听到没有！快点给我通过', '2023-08-07 19:52:27', '2023-08-07 19', '2023-09-08 00', 'http://localhost:9090/file/b3335cd3fae54706b75abd947c309235.jpg', '审核通过...你可以滚回去了');
...
-- Records of salary
-- ----------------------------
INSERT INTO `salary` VALUES (1, 5, '吕成龙', '2023-08-07', 500, 200, 200, 500);
INSERT INTO `salary` VALUES (5, 5, '海绵宝宝', '2023-08-07', 2000, 1000, 100, 3000);
INSERT INTO `salary` VALUES (12, 5, '派大星', '2023-08-07', 1222, 0, 222, 1000);
INSERT INTO `salary` VALUES (13, 5, '章鱼哥', '2023-08-07', 1000, 0, 0, 1000);
INSERT INTO `salary` VALUES (14, 8, '蟹老板', '2023-08-07', 1000, 2000, 500, 2500);
INSERT INTO `salary` VALUES (15, 5, '珊迪', '2023-08-07', 20000, 1000, 500, 20500);
INSERT INTO `salary` VALUES (16, 7, '痞老板', '2023-07-28', 1000, 50, 0, 1050);
INSERT INTO `salary` VALUES (21, 14, '海绵宝宝', '2023-08-07', 3000, 1000, 500, 3500);
INSERT INTO `salary` VALUES (26, 16, '派大星', '2023-08-10', 3000, 3000, 0, 6000);
...
INSERT INTO `sys_menu` VALUES (22, '出勤管理', '/attend', 'el-icon-phone', NULL, NULL, 'attend', 999);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '吕成龙', 'admin@qq.com', '13988997788', '湖北武汉', '2023-07-28 21:10:27', 'http://localhost:9090/file/b3335cd3fae54706b75abd947c309235.jpg', 'ROLE_ADMIN');
INSERT INTO `sys_user` VALUES (2, 'baby', '123', '海绵宝宝', 'zhang@qq.com', '13677889900', '南京', '2023-07-28 22:10:14', NULL, 'ROLE_USER');
INSERT INTO `sys_user` VALUES (3, 'star', '123', '派大星', 'wang@qq.com', '13877668855', '上海', '2023-07-28 22:10:18', 'http://localhost:9090/file/7737484487db47ab89e58504ddf86ac1.jpg', 'ROLE_USER');
INSERT INTO `sys_user` VALUES (8, 'bother', '123', '章鱼哥', NULL, NULL, NULL, '2023-08-07 19:51:06', NULL, 'ROLE_USER');
